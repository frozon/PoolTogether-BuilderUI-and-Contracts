...
import PoolWithMultipleWinnersBuilderMatic from '../../pooltogether-pool-contracts-master/deployments/matic/PoolWithMultipleWinnersBuilder.json'
...
import PoolWithMultipleWinnersBuilderCelo from '@pooltogether/pooltogether-contracts/deployments/celo/PoolWithMultipleWinnersBuilder.json'
import PoolWithMultipleWinnersBuilderCeloTestnet from '@pooltogether/pooltogether-contracts/deployments/celoTestnet/PoolWithMultipleWinnersBuilder.json'
...
import RNGBlockhashCelo from '@pooltogether/pooltogether-rng-contracts/deployments/celo_42220/RNGBlockhash.json'
import RNGBlockhashCeloTestnet from '@pooltogether/pooltogether-rng-contracts/deployments/celoTestnet_44787/RNGBlockhash.json'
...
export const SUPPORTED_NETWORKS = [1, 4, 42, 56, 77, 97, 100, 137, 31337, 42220, 44787, 80001]
...
export const CONTRACT_ADDRESSES = {
  ...
  42220: {
    POOL_WITH_MULTIPLE_WINNERS_BUILDER: PoolWithMultipleWinnersBuilderCelo.address,
    RNG_SERVICE: {
      blockhash: RNGBlockhashCelo.address
    }
  },
  44787: {
    POOL_WITH_MULTIPLE_WINNERS_BUILDER: PoolWithMultipleWinnersBuilderCeloTestnet.address,
    RNG_SERVICE: {
      blockhash: RNGBlockhashCeloTestnet.address
    }
  }
}
